...
* @param {string} [baseURL=''] - baseURL. MUST end with slash('/'). Empty means default URL.
*/
Phaser.Game = function (width, height, renderer, parent, state, transparent, antialias, physicsConfig, baseURL) {
    ...
    */
    boot: function () {
		...
		if (this.config && this.config['baseURL']) {
			this.load.baseURL = this.config['baseURL'];
		}
