...
([
  ...
  (function(module, exports, __webpack_require__) {
    ...
    /**self----------------------*/
    var parentNode = function (_EventTarget) {
      _inherits(parentNode, _EventTarget)

      function parentNode() {
        _classCallCheck(this, parentNode)

        var _this = _possibleConstructorReturn(this, (parentNode.__proto__ || Object.getPrototypeOf(parentNode)).call(this))
